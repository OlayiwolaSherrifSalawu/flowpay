...
class DemoApprovalRepository implements ApprovalRepository {
  final List<PendingApprovalModel> _approvals = [
    PendingApprovalModel(
      ...
      description:
          'Auto-sweep \$400.00 USD → ₦620,000 NGN into Lagos Savings Wallet',
      ...
      metadata: {
        'ruleName': '20% Emergency Fund Auto-Sweep',
        'trigger': 'Incoming Client Wire \$2,000.00'
      },
    ),
    PendingApprovalModel(
      id: 'appr_02',
      ...
      description:
          'Outbound BMONI settlement \$500.00 USD → \$8,750 MXN (Mexico City)',
    ...
    PendingApprovalModel(
      ...
      description:
          'Target exchange rate reached (1550.00). Convert \$1,000 USD to ₦1,550,000 NGN',
      ...
      status: ApprovalStatus.pending,
      metadata: {
        'orderType': 'Limit Order Triggered',
        'targetVault': 'CNGN Vault'
      },
    ),
  ];
  ...
  Future<bool> approveAction(String approvalId, {String? pin}) async {
    ...
    if (idx != -1) {
      _approvals[idx] =
          _approvals[idx].copyWith(status: ApprovalStatus.approved);
      return true;
    }
    return false;
  }
  ...
  Future<bool> rejectAction(String approvalId, {String? reason}) async {
    ...
    if (idx != -1) {
      _approvals[idx] =
          _approvals[idx].copyWith(status: ApprovalStatus.rejected);
      return true;
    }
    return false;
  }
